package aplicaciones.sainz.jorge.restcontprov.datos;
...
import aplicaciones.sainz.jorge.restcontprov.conversores.ConversorPersona;
...
public class Persona implements Serializable, Comparable<Persona>,Parcelable {
    ...
    public int compareTo(@NonNull Persona o) {
        ...
        return cedula.compareTo(o.getCedula()) ;
    }
